          ...
          <div class="flex gap-5 items-center pl-6">
            ...
            <?php if($auth->checkUser()): ?>
                ...
                <?php if($auth->checkAdmin()): ?>
                    <a href="admin_manage.php" class="block px-4 py-2 rounded-lg hover:bg-gray-100">Manage (Admin)</a>
                <?php endif; ?>
                <a href="orders.php" class="block px-4 py-2 rounded-lg hover:bg-gray-100">Orders</a>
